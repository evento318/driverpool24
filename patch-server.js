...
if (start === -1 || end === -1 || end <= start) throw new Error('Login route could not be located in server.js');
...
await fs.writeFile(file, source.slice(0,start) + fixedRoutes + source.slice(end), 'utf8');
